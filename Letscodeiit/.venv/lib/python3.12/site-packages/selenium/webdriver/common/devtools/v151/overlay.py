...
class DisplayCutoutConfig:
    ...
    def from_json(cls, json):
        return cls(
            ...
            border_radius=int(json['borderRadius']) if 'borderRadius' in json else None,
            upper_radius=int(json['upperRadius']) if 'upperRadius' in json else None,
            lower_radius=int(json['lowerRadius']) if 'lowerRadius' in json else None,
            cx=int(json['cx']) if 'cx' in json else None,
            cy=int(json['cy']) if 'cy' in json else None,
            radius=int(json['radius']) if 'radius' in json else None,
            content_color=dom.RGBA.from_json(json['contentColor']) if 'contentColor' in json else None,
        )
